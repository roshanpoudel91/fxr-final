<figure class="fxr-banner">
    <picture>
        ...
        <img src="{{ URL::asset('sample-banner-mobile.jpg') }}" alt="Flowers" style="width:auto;">
    </picture>
    <!--
    <img src="{{ URL::asset('sample-banner.jpg') }}" srcset="{{ URL::asset('sample-banner-mobile.jpg') }} 800w,
        {{ URL::asset('sample-banner.jpg') }} 1600w" alt="Boy on bike"> -->
</figure>
